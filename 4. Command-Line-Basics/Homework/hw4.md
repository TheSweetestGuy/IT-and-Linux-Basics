...
Выберите файл iso-образа Oracle Linux:

<a href="https://ibb.co/tPcyrDt"><img src="https://i.ibb.co/3YWtZcq/2-01-3.png" alt="2-01-3" border="0"></a>

3.	Скачайте [дистрибутив Oracle Linux](https://yum.oracle.com/oracle-linux-isos.html) с официального сайта.

4.	Установите Oracle Linux на вашу виртуальную машину.
      - имя компьютера - на ваше усмотрение
      - домен - пустое поле или задайте домен
      - пароль суперюзера - пустое поле или задайте свой пароль
      ...
      (Oracle Linux desktop environment), оставить (или добавить) стандартные системные утилиты (standard system utilities), добавить SSH server
...
Подключитесь к виртуальной машине, откройте консоль и выполните следующее:
...
Обновите список пакетов, обновите систему (используя yum или dnf)
